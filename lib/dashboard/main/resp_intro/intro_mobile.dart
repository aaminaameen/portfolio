...
class IntroductionMobile extends StatefulWidget {
  final Key? key;
  IntroductionMobile({this.key}) : super(key: key);

  @override
  State<IntroductionMobile> createState() => _IntroductionMobileState();
}
                ...
                children: [
                  ...
                  AnimatedTextKit(animatedTexts: [
                    TyperAnimatedText(
                      ...
                      textStyle:
                          GoogleFonts.aladin(color: kBlackColor, fontSize: 35),
                    ),
                  ]),
